...
def englishFreqMatchScore(message):
	...
	#and six least frequent letters is among the six most frequent and six least frequent
	#letters for English.
	freqOrder = getFrequencyOrder(message)

	matchScore = 0
	#Find how many matches for the six most common letters they are.
	for commonLetter in ETAOIN[:6]:
		if commonLetter in freqOrder[:6]:
			matchScore += 1
	#find how many matches for the first six least common letters they are.
