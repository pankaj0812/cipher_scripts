...
def removeSolvedLettersFromMapping(letterMapping):
	...
	#For example, if 'A' maps to other potential letters ['M', 'N'] and 'B'
	#maps to ['N'], then we know that 'B' must map to 'N', so we can remove 'N'
	#from the list of what 'A' could map to. So 'A' then maps to ['M']. Note that now that
	#'A' maps to only one letter, we can remove 'M' from the list of letters for evrry 
